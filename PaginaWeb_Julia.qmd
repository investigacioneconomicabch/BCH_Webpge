...
Para obtener el archivo de Excel desde donde se extraen todas las series (`wd * "data/archivos.csv"`), ejecutar el procedimiento del archivo `crape_bch.py` de la carpeta `functions`.
