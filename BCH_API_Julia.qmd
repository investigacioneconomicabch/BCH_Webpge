...
```{julia}
url = "https://bchapi-am.azure-api.net/api/v1/indicadores/?formato=Json&nombre=PIBT"
...
```{julia}
id = 36
url = "https://bchapi-am.azure-api.net/api/v1/indicadores/" * string(id) * "/cifras?FechaInicio=2021-03-01&FechaFinal=2023-09-01"
...
```{julia}
ids = 1,29 # Total de indicadores: 11519
get_data_indicators(key,ids)
```

```{julia}
ids = 1 # Total de indicadores: 11519
